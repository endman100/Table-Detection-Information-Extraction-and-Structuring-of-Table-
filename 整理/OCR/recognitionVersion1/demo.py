    ...
    with torch.no_grad():
        for image_tensors, image_path_list in demo_loader:
            ...
            for img_name, pred, pred_max_prob in zip(image_path_list, preds_str, preds_max_prob):
                ...
                confidence_scoreList.append(confidence_score)
    return img_nameList, predList, confidence_scoreList
...
def index():
    ...
    parser.add_argument('--saved_model',  default="checkpoint/TPS-ResNet-BiLSTM-Attn.pth", help="path to saved_model to evaluation")
    """ Data processing """
...
if __name__ == '__main__':
    img_name, pred, confidence_score = index()
